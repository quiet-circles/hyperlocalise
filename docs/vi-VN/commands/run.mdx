...
Khi một danh mục khai báo `sourceLanguage`, mỗi mục đã được phân tích/nhân bản phải bao gồm ngôn ngữ nguồn đó trong `localizations`; nếu không thì `run` bị lỗi phân tích cú pháp/tuần tự hóa.
