...
You can run multiple LLM providers and integrate with common TMS adapters (for example Crowdin, LILT AI, Lokalise, Phrase, POEditor, and Smartling) without redesigning your entire workflow around one vendor.
...
### Can I use Hyperlocalise with Crowdin, Lokalise, POEditor, or LILT AI?

Yes. Hyperlocalise supports multiple TMS adapters, including Crowdin, LILT AI, Lokalise, Phrase, POEditor, and Smartling.
...
Workflow selection guide: [Workflow decision guide](/workflows/workflow-decision-guide)

Feature maturity reference: [Stability matrix](/reference/stability-matrix)
